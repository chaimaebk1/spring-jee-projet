...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configAuthentication(AuthenticationManagerBuilder auth)throws  Exception{
                    ...
                    .usersByUsernameQuery("select username, password, enabled from admins where username=?")//query to select user by username
                    .authoritiesByUsernameQuery("select username, role from admins where username=?");//to give authorized user when username and password true
    }
